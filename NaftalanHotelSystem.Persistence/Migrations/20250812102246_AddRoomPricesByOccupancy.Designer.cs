...
namespace NaftalanHotelSystem.Persistence.Migrations
{
    ...
    [Migration("20250812102246_AddRoomPricesByOccupancy")]
    partial class AddRoomPricesByOccupancy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NaftalanHotelSystem.Domain.Entites.RoomPriceByOccupancy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RoomPricesByOccupancy");
                });
            ...
            modelBuilder.Entity("NaftalanHotelSystem.Domain.Entites.RoomPriceByOccupancy", b =>
                {
                    b.HasOne("NaftalanHotelSystem.Domain.Entites.Room", "Room")
                        .WithMany("RoomPricesByOccupancy")
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NaftalanHotelSystem.Domain.Entites.Room", b =>
                {
                    ...
                    b.Navigation("RoomPricesByOccupancy");
